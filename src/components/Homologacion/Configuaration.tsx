...
import TableHomol from "./TableHomol";
...
const Configuration = () => {
  return (
    <div className="flex flex-row">
      ...
      <div className="w-full relative bg-whitesmoke overflow-hidden flex flex-col items-start justify-start pt-10 px-[18px] pb-[20px] box-border tracking-[normal] leading-[normal] mq450:pl-5 mq450:pr-5 mq450:box-border mq750:pl-[59px] mq750:pr-[59px] mq750:box-border">
        <div className="w-10 h-[30px] absolute !m-[0] top-[0px] left-[2px] z-[2]">
